...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2019 at 07:53 PM
...
('1102201113415691', 'Asus x450C', 'PTCS', '1', 'ASSET', '1', 'SURABAYA', '02', 'SBY', '20', '2013-11-14', 'PERALATAN ELEKTRONIK', '4', '41', 'LAPTOP / NOTEBOOK / TABLET', '1', '5691');
...
INSERT INTO `stock` (`id_stock`, `item_code`, `nama_stock`, `quantity`, `last_in`, `last_out`, `Keterangan`) VALUES
(2, 'HDWD500G', 'Hard Disk Western Digital 500GB', 5, '2019-03-07', '2019-03-08', ''),
(3, 'RAM4GBKI', 'RAM 4GB DDR3 KINGSTON', 4, '2019-07-04', '0000-00-00', '');
...
INSERT INTO `stock_trans` (`id_trans`, `item_code`, `nama_stock`, `inout`, `quantity`, `tanggal`, `vendor`, `no_po`, `nama_emp`) VALUES
(2, 'HDWD500G', 'Hard Disk Western Digital 500GB', 'in', 10, '2019-03-07', 'Perikom', '14514', 'Handi Irawan'),
(6, 'HDWD500G', 'Hard disk Western Digital 500GB', 'out', 5, '2019-03-08', 'Perikom', '14514', 'Handi Irawan'),
(7, 'RAM4GBKI', 'RAM 4GB DDR3 KINGSTON', 'in', 4, '2019-07-04', 'Perikom', '14517', 'Handi Irawan');
...
(1212, 'test2', 'ad0234829205b9033196ba818f7a872b', 'user', '1'),
...
ALTER TABLE `stock`
  ...
  ADD UNIQUE KEY `kode_stock` (`item_code`);
...
--
ALTER TABLE `stock`
  MODIFY `id_stock` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `stock_trans`
--
ALTER TABLE `stock_trans`
  MODIFY `id_trans` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
